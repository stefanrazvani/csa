...
const SCENES = Object.freeze({
  ...
  1: {
    ...
    environment: {
      ...
      camera: [0, 2.7, 9.9], target: [0, 1.5, -5.2],
      floor: { ...LODGE_FLOOR },
  ...
  2: {
    ...
    environment: {
      ...
      camera: [-3.6, 3.05, 8.8], target: [0.4, 1.7, -5.6],
      floor: { ...LODGE_FLOOR },
  ...
  3: {
    ...
    interactives: [
      ...
      interactive('project-seed', 'project', 'Masa proiectelor', 'Transformă o idee argumentată într-o inițiativă de grup.', [4.9, 0.95, -1.2], { type: 'dodecahedron', size: 0.88 }, ROUTES.library,
        learning('De la sens la faptă', 'Care este cel mai mic rezultat util pe care grupul îl poate produce?', ['Definește beneficiarul.', 'Stabilește rezultatul și responsabilitățile.', 'Revizuiește progresul fără competiție.']), { sourceRef: 'Catalog intern · gradul 3' }),
